...
| `PO-004` | COMPATIBILITY POLICY | INCORPORATED | production implementation is active under the accepted v1 clean-slate horizon; task-local schema/version changes may replace unreleased shapes without legacy migration, while release/migration execution remains separately gated | v1 clean-slate compatibility owner decision; current Version Impact gates; active implementation; later release/migration acceptance | NONE |
