...
| M09 | `DEV/ARCHITECTURE/MECHANICAL_CONTEXT.md` and `DEV/TESTS/test_s6d_04_mechanical_context_contract.py` | MechanicalContext is a bounded deterministic mechanical-stage accessor/invocation-fact contract with disposable derived caches and pinned state view. | Explicitly separate owner. It cannot carry R2.3 role-context source eligibility, Actor/private cognition, broad retrieval or continuity authority. |
