...
| AR-06 exact pinning vs maintenance | CHALLENGE | unchanged ruleset set remains silent maintenance; changed set is correctly semantic adoption | CLOSED / NO CHANGE |
...
- campaign creator semantic-adoption authority;
- non-creator silent maintenance only when rules semantics are unchanged;
