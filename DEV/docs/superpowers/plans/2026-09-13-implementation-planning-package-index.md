...
Historical public graph/audit evidence through F47 remains in `2026-09-14-implementation-planning-authority-dependency-graph-audit.md` plus its F44–F47 synchronization deltas. Those files are audit/control evidence, not executable overlays or semantic owners. New author-audit cursor, graph decomposition and investigation bookkeeping after F47 are maintained outside the public product/planning tree; this router plus mandatory overlays remain the public executable-package authority.
