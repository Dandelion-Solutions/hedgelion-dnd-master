...
Current coverage: `2026-09-14-implementation-planning-bidirectional-coverage-v3-post-graph.md`, amended by the F27–F31 control amendment and F34–F55 later-precedence item-bound amendments plus F57's F36 verification-command correction; F49 is control-plane only and adds no product coverage row.
