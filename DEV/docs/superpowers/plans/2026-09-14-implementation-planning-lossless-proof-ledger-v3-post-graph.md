...
Date: 2026-09-14
Finding origin: **AUTHOR FINDING 20 — SIGNIFICANT**, extended through Finding 23.
...
Finding 23 does not add a native family. Its catalog-context basis and owner-local definition dependency refs are embedded accepted-execution evidence and therefore must not alter the 17+17 census.
...
PG23's primary executable witnesses are named in the current witness matrix:
