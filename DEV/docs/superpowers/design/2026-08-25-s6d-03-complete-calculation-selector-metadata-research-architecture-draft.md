...
| `attack.roll` | DORMANT / S6D-03 trigger | `DEV/ARCHITECTURE/MECHANICAL_RUNTIME_PROPOSAL.md`<br>`DEV/docs/superpowers/design/2026-08-19-step-2-health-effect-selector-query-boundary-design.md`<br>`DEV/SCHEMAS/condition-definition-data.schema.json`<br>`DEV/TESTS/test_step2_mechanical_examples.py` | structural/historical/unresolved; nonselectable |
...
| `damage.received` | DORMANT / S6D-03 trigger | `DEV/docs/superpowers/design/2026-08-19-step-2-health-effect-selector-query-boundary-design.md` | structural/historical/unresolved; nonselectable |
...
| `healing.received` | DORMANT / S6D-03 trigger | `DEV/docs/superpowers/design/2026-08-19-step-2-health-effect-selector-query-boundary-design.md` | structural/historical/unresolved; nonselectable |
| `resource.cost` | DORMANT / S6D-03 trigger | `DEV/docs/superpowers/design/2026-08-19-step-2-health-effect-selector-query-boundary-design.md` | structural/historical/unresolved; nonselectable |
| `resource.capacity` | ACTIVE / COMPLETE | accepted Step-2 owner + current focused validation | complete machine metadata |
| `resource.recovery` | DORMANT / S6D-03 trigger | `DEV/ARCHITECTURE/RULE_ELEMENT_MODEL.md`<br>`DEV/CATALOG/mechanical-surfaces.json`<br>`DEV/docs/superpowers/design/2026-08-18-step-2-mechanical-state-ownership-design.md`<br>`DEV/docs/superpowers/design/2026-08-19-step-2-health-effect-selector-query-boundary-design.md`<br>`DEV/TESTS/test_step2_evaluation_input_contract.py` | structural/historical/unresolved; nonselectable |
...
| `effect.duration` | DORMANT / S6D-03 trigger | `DEV/ARCHITECTURE/RULE_ELEMENT_MODEL.md`<br>`DEV/CATALOG/mechanical-surfaces.json`<br>`DEV/docs/superpowers/design/2026-08-19-step-2-health-effect-selector-query-boundary-design.md`<br>`DEV/TESTS/test_step2_evaluation_input_contract.py` | structural/historical/unresolved; nonselectable |
