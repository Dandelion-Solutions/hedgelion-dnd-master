...
| Documentation / routing / supersession consistency | `DEV/docs/superpowers/specs/2026-09-09-r2-7-WP-26-documentation-routing-supersession-consistency-canonical-spec.md` | current native semantic owners, accepted amendments including PO-009/PO-010, `DEV/PRODUCT_OWNER_INPUT.md`, current machine guards/tests; this map/index remain derivative and accepted architecture must stay distinct from deferred realization |
