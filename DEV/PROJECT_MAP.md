...
- `research/2026-08-27-s6d-09-domain-rules-coverage-matrix-research-architecture-draft.md` and `specs/2026-08-27-s6d-09-domain-rules-coverage-matrix-decision-brief.md` — Step-2 exact package/machine/product evidence and Step-3 supported-surface decision gate; route here before attempting S6D-09 Steps 4-8.
