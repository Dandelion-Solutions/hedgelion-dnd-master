...
- `specs/2026-08-26-s6d-08-hp-lifestate-resource-effect-condition-duration-recovery-task-brief.md` and matching `-brief-critic.md` — S6D-08 Step-1 framing and whole-project brief-critic PASS; Step 2 is not yet started.
...
Route S6D-08 through its Step-1 task brief, then exact Step-2 Resource/HP/LifeState/Effect/Condition assurance owners, Step-3 execution, Step-5.2/5.3/5.7/5.9/5.13 continuity and recovery owners, S6D-03…07 machine contracts, and the current schemas/catalogs/tests. Preserve S6D-07 narrow consumer authority; do not infer a generic scheduler, Effect/Resource authority or broad content admission.
