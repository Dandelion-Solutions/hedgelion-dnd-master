...
- `specs/2026-08-27-s6d-10-campaign-rulings-house-rule-boundary-integration-task-brief.md` and matching `-brief-critic.md` — S6D-10 Step-1 framing and mandatory whole-project critic PASS for one-off typed adjudication plus durable policy-realization integration; Step 2 remains not started.
