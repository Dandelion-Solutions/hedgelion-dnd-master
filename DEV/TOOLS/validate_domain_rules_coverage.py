...
def execute_mechanical_null_resolution(req,receipts=None):
 ...
 owner_id=f"resolution:{key}";segment_id=f"{owner_id}:segment:1";event_id=f"{segment_id}:event:1";segment={"segment_id":segment_id,"segment_sequence":1,"commit_state":"committed","resulting_execution_state":"COMPLETED","event_ids":[event_id],"pending_child_invocations":[],"receipt_exports":{"result":result,"roll_total":total,"rng_result_ref":roll["rng_result_ref"]},"affected_revision_refs":[]}
