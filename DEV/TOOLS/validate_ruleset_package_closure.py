...
ACTIVITY_PRIMITIVE_CONTRACTS_MEMBER_PATH = "DEV/CATALOG/activity-primitive-contracts.json"
...
ENGINE_CONTRACT_SOURCE_GROUPS = {
    ...
    "primitive": (("activity_primitive_contracts", ACTIVITY_PRIMITIVE_CONTRACTS_MEMBER_PATH),),
    "portable_value": (
