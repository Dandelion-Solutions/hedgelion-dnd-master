...
For material combat rules, prefer stored/official D&D 2024/SRD 5.2.1 data. If uncertain, verify rather than inventing a permanent rule.

A fast temporary ruling is acceptable to maintain flow, but record it if consistency may matter later.
